"""
Convert cobalamin_pernicious_anemia_important_edges.csv to the TracIn format.
...
CURIE_MAP = {
    # Drug
    "Cobalamin": "CHEBI:30411",
    "Cyanocobalamin": "CHEBI:17439",
    # Disease
    "pernicious anemia": "MONDO:0009062",
}
...
PREDICATE_MAP = {
    ...
    "biolink:has_adverse_event": "predicate:22",
    "biolink:contraindicated_in": "predicate:10",
}
...
def get_curie(name: str) -> str:
    ...
    elif any(kw in name_lower for kw in ["disease", "syndrome", "disorder", "anemia", "osis", "itis", "cancer", "carcinoma"]):
...
def main():
    input_path = Path("/Users/jchung/Documents/RENCI/everycure/experiments/Influence_estimate/gnnexplain/data/08_reporting/cobalamin_pernicious_anemia_important_edges.csv")
    output_path = input_path.parent / "cobalamin_pernicious_anemia_important_edges_tracin_format.csv"
