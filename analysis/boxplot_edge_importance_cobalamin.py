...
For Cobalamin -> biolink:treats -> pernicious anemia
"""
...
def main():
    # Load file (no header)
    input_path = Path("/Users/jchung/Documents/RENCI/everycure/experiments/Influence_estimate/gnnexplain/data/08_reporting/Cobalamin_1000_edges.csv")
    ...
    ax.set_title("Edge Importance by Predicate Type\nCobalamin -> biolink:treats -> pernicious anemia", fontsize=14)
    ...
    output_path = output_dir / "Cobalamin_1000_edges_boxplot.png"
    plt.savefig(output_path, dpi=150, bbox_inches='tight')
    print(f"\nPlot saved to: {output_path}")

    # Also save as PDF
    pdf_path = output_dir / "Cobalamin_1000_edges_boxplot.pdf"
