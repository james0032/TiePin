...
# Test triples file
TEST_TRIPLES="/projects/aixb/jchung/everycure/influence_estimate/robokop/clean_baseline/test_results/scores_test_ahc.txt"

# Output directory
OUTPUT_DIR="/projects/aixb/jchung/everycure/influence_estimate/robokop/clean_baseline/results/batch_tracin_top50"
