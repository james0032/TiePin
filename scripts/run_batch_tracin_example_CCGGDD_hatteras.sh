...
MODEL_PATH="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/models/conve/checkpoints/checkpoint_epoch_0000016.pt"
TRAIN_FILE="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/train.txt"
ENTITY_TO_ID="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/processed/node_dict.txt"
RELATION_TO_ID="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/processed/rel_dict.txt"
EDGE_MAP="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/edge_map.json"
NODE_NAME_DICT="/projects/aixb/jchung/everycure/influence_estimate/robokop/CCGGDD_alltreat/processed/node_name_dict.txt"
